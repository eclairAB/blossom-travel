...
function blossom_travel_primary_nagivation(){     
    $add_munu_class = ( has_nav_menu( 'primary' ) ) ? '' : ' menu-fallback';  ?>
    	<nav id="site-navigation" class="main-navigation<?php echo esc_attr( $add_munu_class ); ?>" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
...
?>
	...
	<?php endif; ?>
        ...
        <footer class="comment-meta">
            ...
            <?php printf( __( '<b class="fn" itemprop="creator" itemscope itemtype="http://schema.org/Person">%s<span class="says">says:</span></b>', 'blossom-travel' ), get_comment_author_link() ); ?>
...
*/
function blossom_travel_is_btif_activated(){
...
function blossom_travel_header_background_image() {
    ...
    if( is_singular() ){
        ...
        if( $image_id ) {
            ...
            $return = get_theme_mod( 'header_background_image', get_template_directory_uri() .'/images/header-bg.jpg' );
        }    
    }else{
        $return = get_theme_mod( 'header_background_image', get_template_directory_uri() .'/images/header-bg.jpg' );
    }
