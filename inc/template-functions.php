                      ...
                      <?php if( $banner_title ) : ?>
                        <div>
                          <h3 class="entry-title">
                            <?php if( $banner_title ) echo esc_html( $banner_title ); ?>
                          </h3>
                        </div>
                      <?php endif;
                      if( $banner_title ) echo '';
                      if( $banner_label ) : ?>
                        <div class="entry-label"><?php echo esc_html( $banner_label);?></div>
                      <?php endif;
                      if( $banner_link ) : ?> 
                          <!-- <div>
                            <a href="<?php esc_url($banner_link);?>" class="btn btn-1 icon-info">
                              <span style="text-shadow: 2px 2px 4px black;">Start Tour</span>
                            </a>
                          </div> -->
                      </div></div>
                      <?php endif;
...
function blossom_travel_content_start(){       
    ...
    if( ! ( is_front_page() && ! is_home() && $home_sections ) ){ ?>
        ...
        <!-- ==================== this part for pages customizations ==================== -->
                    ...
                    <div class="container">
                        <?php
                            ...
                            if( is_search() ) : ?>
                                ...
                                <div class="search-header-container align-items-center">
                                    <div>
                                        <?php global $wp_query;
...
function blossom_travel_entry_content(){ 
    ...
    <div class="entry-content container mt-4" itemprop="text">
		<?php
...
function header_links_init() {
    register_sidebar(array(
      'name'              => esc_html__('Navbar links', 'wp-bootstrap-starter-child'),
      'id'                => 'nav-links',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
      'before_title'      => '<h6 class="widget-title">',
      'after_title'       => '</h6>',
    ));
}
add_action('widgets_init', 'header_links_init');

function tafri_travel_widgets_init() {
    register_sidebar(array(
      'name'              => esc_html__('Footer 1', 'wp-bootstrap-starter-child'),
      'id'                => 'footer-1',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
    ...
    register_sidebar(array(
      'name'              => esc_html__('Footer 2', 'wp-bootstrap-starter-child'),
      'id'                => 'footer-2',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
    ...
    register_sidebar(array(
      'name'              => esc_html__('Footer 3', 'wp-bootstrap-starter-child'),
      'id'                => 'footer-3',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
    ...
    register_sidebar(array(
      'name'              => esc_html__('Footer 4', 'wp-bootstrap-starter-child'),
      'id'                => 'footer-4',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
    ...
    register_sidebar(array(
      'name'              => esc_html__('Footer 5', 'wp-bootstrap-starter-child'),
      'id'                => 'footer-5',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
    ...
    register_sidebar(array(
      'name'              => esc_html__('Footer 6', 'wp-bootstrap-starter-child'),
      'id'                => 'footer-6',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
...
function carousel_horizontal_posts_content_slider_init() {
    register_sidebar(array(
      'name'              => esc_html__('Slider plugin', 'wp-bootstrap-starter-child'),
      'id'                => 'slider-plugin',
      'description'       => esc_html__('Add widgets here.', 'wp-bootstrap-starter-child'),
      'before_widget'     => '<div id="%1$s" class="text-left widget %2$s">',
      'after_widget'      => '</div>',
...
add_action('widgets_init', 'carousel_horizontal_posts_content_slider_init');