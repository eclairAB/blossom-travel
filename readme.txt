...
Owl-carousel-aria, Stephan Fischer
License : CCO
Source  : https://github.com/stephan-fischer/owl-aria
...
== Changelog ==
    ...
    1.0.2
    	Fixed
    	* name of recommended plugin
        * fix issue of breadcrumb
        * fix custom header issue in blog 
        * fix issue of sidebar in search
    ...
    1.0.1
        ...
        * fix issue of sidebar in search
	    ...
	    Improved
	    * related article category font size
	    * footer link changed
	    * documentation link changed
	    * theme accessibility ready

	    Added 
	    * free vs pro image
	    * breadcrumb feature
	    * updated on text in single and blog
	    * options to change the related project title
